/**
 * zds dashboardTheme runtime → an-dashboard-theme.js
 * Palette A fills + canon rounded-tiers reshape after nivo settle.
 * Allure collapses empty funnel bands to zero width — colors-only leaves a blank chart.
 */
(function () {
